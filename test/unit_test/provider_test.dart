...
void main() {
  group("MovieApiProvider test", () {
    test("fetchMovieList success test", () async {
      ...
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/popular?api_key=f044d5c3f2f445d69f402c343ebe81d0"))
    ...
    test("fetchTrailer success test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/420818/videos?api_key=f044d5c3f2f445d69f402c343ebe81d0"))
          .thenAnswer((_) async => http.Response(
    ...
    test("fetchTrailer fail test", () async {
      ...
      var mockClient = app.mockClient;
      when(mockClient.get(
          "http://api.themoviedb.org/3/movie/428/videos?api_key=f044d5c3f2f445d69f402c343ebe81d0"))
          .thenAnswer((_) async => http.Response(
